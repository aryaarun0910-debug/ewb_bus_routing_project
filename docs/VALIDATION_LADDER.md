...
| 7 | **BODS AVL, Birmingham — collector live since 2026-06-12** | The actual buses on the actual Ladywood corridors: lines 80, 8A, 8C, 126 all confirmed captured (~82k observations/day, ~330k obs across 4 days Jun 12–15) | Dwell-time fingerprint per stop per hour — the closest legal observable to Ladywood APC |
| 8 | **TfWM APC data** (pathway identified) | Per-stop observed boardings for routes 8A/8C/80/126 | The gold standard for closing the data gap. Real APC integration is the defined next phase, requiring a data-sharing agreement with TfWM |
...
4. **BODS collector live** since 2026-06-12 — 4 days collected (80/8A/8C/126), ~330k observations.
