...
| 8 | **TfWM APC data** (pathway identified) | Per-stop observed boardings for routes 8A/8C/80/126 | The gold standard for closing the data gap — request route via foi@tfwm.org.uk, using Wellington fyi.org.nz request 14028 as precedent wording. Not yet filed; this rung remains open |
